    ...
    <div className='mx-auto'>
      <div className='flex gap-4'>
        ...
        <div className='w-2/4'>
          ...
          rounded-md p-4 border shadow-md space-y-4' >
            ...
            <button
              ...
              className='bg-blue-500 text-white px-3 py-1 rounded-md shadow-md 
            hover:bg-blue-800 hover:scale-105 hover:translate-y-1 hover:duration-200'>Save Address</button>
          </div>
        </div>
        ...
        {/* ขวา */}
        <div className='w-2/4'>
          <div className='bg-gray-100 rounded-md p-4 border shadow-md space-y-4'>
                  ...
                  <div className='flex justify-between items-end'>
                    ...
                    <div>
                      <p className='text-red-500 font-bold'>
                        {numberFormat(item.count * item.product.price)}</p>
                    </div>
                  </div>
                </div>
              )
            ...
            <div>
              <button
                ...
                rounded-md shadow-md text-white hover:bg-green-900'>ดำเนินการชำระเงิน</button>
            </div>
